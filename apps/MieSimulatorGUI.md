...
desktop:
  Desktop Entry:
    ...
    Exec: MieSimulatorGUI_v2_1
    Icon: MieSimulatorGUI
    Categories: Science
    X-AppImage-Version: 359f6d9
  AppImageHub:
    X-AppImage-UpdateInformation: zsync|https://github.com/VirtualPhotonics/MieSimulatorGUI/releases/download/Version_2.1/MieSimulatorGUI_v*.AppImage.zsync
