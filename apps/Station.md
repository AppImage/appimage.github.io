...
desktop:
  Desktop Entry:
    ...
    X-AppImage-Version: 1.25.1.2271
    MimeType: x-scheme-handler/station
    Categories: Network
    X-AppImage-BuildId: 1B4hWZQpdAxfWyviMoDzenE3vpH
  AppImageHub:
...
electron:
  ...
  dependencies:
    ...
    "@getstation/electron-google-oauth2": "^1.0.3"
    "@getstation/electron-redux": "^1.0.0"
    "@getstation/electron-spellchecker": "^1.1.7"
    "@getstation/frecency": "^1.1.1"
    "@getstation/rx-ipc-electron": "^0.2.1"
    "@getstation/sdk": "^0.6.2"
    "@getstation/services": https://s3.amazonaws.com/dev.getstation.com/package/getstation-services-0.22.1-cbfc73c2ca6e9acaa4d964da87f60a395231af9f.tgz
    "@getstation/theme": "^0.7.1"
    ...
    electron-process-reporter: 1.3.2
