...
permalink: /Firefox_Nightly/
description: Browse the Web

icons:
  - Firefox_Nightly/icons/128x128/firefox-nightly.png

screenshots:
  - Firefox_Nightly/screenshot.png
...
desktop:
  ...
  AppImageHub:
    X-AppImage-UpdateInformation: gh-releases-zsync|srevinsaju|Firefox-AppImage|nightly|Firefox*.AppImage.zsync
